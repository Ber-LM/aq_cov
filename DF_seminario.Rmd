...
final_cod_df <- ha1 %>% 
  ...
  select(FECHA, id_muerte_cov, unidad_muerte, contaminante2, valor_contaminante, alcaldia2, cap_hosp_gral, cap_hosp_uci, densidad_pob, pobreza) %>% 
  rename(contaminante = contaminante2,
         alcaldia = alcaldia2) %>% 
  arrange(id_muerte_cov)

final_nom_df <- ha2 %>%
  select(FECHA, id_muerte_cov, unidad_muerte, contaminante, valor_contaminante, alcaldia, cap_hosp_gral, cap_hosp_uci, densidad_pob, pobreza) %>% 
  arrange(id_muerte_cov)
